    ...
    return {
      ...
      subtasks:
        t.subtasks?.map((s) => ({
          ...
          parentSubtaskId: (s as unknown as { parentSubtaskId?: string | null }).parentSubtaskId ?? undefined,
          delegatedBySpecialistName: (s as unknown as { delegatedBySpecialistName?: string | null }).delegatedBySpecialistName ?? undefined,
          delegationDepth: (s as unknown as { delegationDepth?: number | null }).delegationDepth ?? 0,
        })) ?? [],
      ...
      task.subtasks.map((subtask) =>
        prisma.subtask.upsert({
          ...
          create: {
            ...
            delegatedBySpecialistName: subtask.delegatedBySpecialistName,
            delegationDepth: subtask.delegationDepth ?? 0,
